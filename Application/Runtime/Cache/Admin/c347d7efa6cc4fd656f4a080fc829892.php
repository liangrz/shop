					...
					<div class="tab-content default-tab" id="tab2">
						...
						<form method="post">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								<input hidden = 'hidden' name = 'id' value = '<?php echo ($vo["id"]); ?>'>
								<p>
									<label>商品名字</label>
										<input class="text-input small-input" type="text" id="small-input" name="name" value = '<?php echo ($vo["name"]); ?>'/>
								</p>
